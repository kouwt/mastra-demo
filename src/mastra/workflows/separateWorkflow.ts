...
export const separateWorkflow = new Workflow({
...
separateWorkflow.step(stepOne).then(stepTwo).step(stepThree).then(stepFour).commit();

// const { start } = separateWorkflow.createRun();
